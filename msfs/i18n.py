...
这份和 xpc/i18n.py 是**姊妹文件**，不是副本：结构和键名一样，差别只在提到模拟器
的那几条（MSFS ↔ X-Plane）和他机那一块——XPC 装 CSL 模型包并要一个 XPPython3
插件，这边是直接扫模拟器装好的飞机、经 SimConnect 放进去。
"""
...
TEXT = {
    # ---------- 通用 ----------
    "app.title":            {"zh": "MSFS for CAN", "en": "MSFS for CAN"},
    "app.name":             {"zh": "MSFS for CAN", "en": "MSFS for CAN"},
    ...
    "msg.inject_unavailable": {"zh": "他机注入不可用，详见日志",
                               "en": "Traffic injection is unavailable — see the log"},
    ...
    "dialog.about_body":    {"zh": "{name} {version}\n\n"
                                   ...
                                   "语音走 Mumble，网络走 FSD，飞行数据经 SimConnect "
                                   "取。\n\n日志：{log}",
                             "en": "{name} {version}\n\n"
                                   "The Microsoft Flight Simulator pilot client for the "
                                   "Cerulean Aviation Network.\nVoice over Mumble, network "
    ...
    "settings.render_traffic": {"zh": "把其他飞机放进 MSFS",
                                "en": "Put other aircraft into MSFS"},
    "settings.package_roots": {"zh": "MSFS 包目录", "en": "MSFS package folders"},
    "settings.roots_hint":  {"zh": "留空则自动探测", "en": "Leave empty to detect them"},
    "settings.browse":      {"zh": "添加…", "en": "Add…"},
    "settings.roots_pick":  {"zh": "选择 MSFS 包目录", "en": "Choose an MSFS package folder"},
    # 探测结果是运行时算出来的，所以拆成两条而不是塞进 traffic_note 里
    "settings.roots_detected": {"zh": "自动探测到 {count} 个包目录。",
                                "en": "Detected {count} package folder(s)."},
    "settings.roots_none":  {"zh": "没有自动探测到包目录，请手工指定。",
                             "en": "No package folder was detected — please add one."},
    "settings.roots_separator": {"zh": "多个目录用中文分号分隔。",
                                 "en": "Separate several folders with a Chinese semicolon (；)."},
    "settings.range":       {"zh": "显示范围", "en": "Range"},
    "settings.range_suffix": {"zh": " 海里", "en": " NM"},
    "settings.traffic_note": {"zh": "不需要装任何插件——他机是通过 SimConnect 直接放进"
                                    "模拟器的，\n而且因为它们是真的 AI 飞机，座舱的交通"
                                    "显示本来就看得见。\n\n"
                                    "机型是从装好的飞机里挑的，读的是各个 aircraft.cfg "
                                    "里的 title。\n装的飞机越多，别人的涂装越准；一架都"
                                    "匹配不到时会用兜底模型。\n\n",
                              "en": "No plugin is needed — other aircraft go straight into "
                                    "the simulator over SimConnect,\nand because they are "
                                    "real AI aircraft the cockpit traffic display already "
                                    "sees them.\n\n"
                                    "Models come from the aircraft you have installed, read "
                                    "from each aircraft.cfg's title.\nThe more aircraft you "
                                    "have, the better other people's liveries match; when "
                                    "nothing matches\na fallback model is used.\n\n"},
